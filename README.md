# CMST385 – Course Projects

This repository contains coursework for **CMST385**.

## Live Site (Azure App Service)

Projects are deployed using **GitHub Actions** to Azure App Service.

⚠️ **Important Deployment Note**  
The live site is served from a **subdirectory**, not the root URL.
